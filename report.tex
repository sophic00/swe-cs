...
\raggedright
{\color{covernavy}\bfseries Academic Details\par}
\vspace{0.28cm}
\small
{\bfseries Course\par}
Software Engineering\par
\vspace{0.22cm}
{\bfseries Case Study No.\par}
12\par
\vspace{0.22cm}
{\bfseries Focus\par}
...
\raggedright
{\color{covernavy}\bfseries Submission Details\par}
\vspace{0.28cm}
\small
...
{\large\color{covernavy}\bfseries Vellore Institute of Technology\par}
\vspace{0.15cm}
{\normalsize\color{black!65}Department of Software Engineering Coursework\par}
