...
\includegraphics[width=3cm]{VIT_logo.png}

\vspace{1cm}

{\Huge\bfseries Technical Debt and Hotspot
Identification in Open-Source
Software Projects\par}

\vspace{1cm}
{\Large A Case Study on \texttt{django/django} and \texttt{huggingface/transformers}\par}
...
\begin{tabular}{rl}
\textbf{Name:}                & Vaibhav Sijaria \\[8pt]
\textbf{Registration Number:} & 23BCI0063 \\[8pt]
\textbf{Course:}              & Software Engineering \\[8pt]
...
Table~\ref{tab:artifacts} lists every artifact produced during the study.

\begin{table}[!htb]
\centering
\caption{Project artifacts and their roles}
\label{tab:artifacts}
...
\texttt{django\_complexity.csv} / \texttt{transformers\_complexity.csv} & Raw static-analysis results \\
\texttt{django\_history.csv} / \texttt{transformers\_history.csv}       & Raw history-mining results \\
