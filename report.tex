...
{\LARGE\bfseries Technical Debt and Hotspot Identification:\\[4pt]
Complexity, Churn, and Code Smell Analysis\par}

\vspace{0.6cm}

{\large A Case Study on Evaluating Hotspot Identification\\
in \texttt{django/django} and \texttt{huggingface/transformers}\par}

\vspace{1.2cm}

\includegraphics[width=4.5cm]{VIT_logo.png}

\vspace{1.2cm}

\begin{tabular}{r@{\hspace{6pt}:\hspace{6pt}}l}
\textbf{Course}          & Software Engineering \\[4pt]
\textbf{Case Study No}   & 12 \\
\end{tabular}
...
\begin{tabular}{r@{\hspace{6pt}:\hspace{6pt}}l}
\textbf{Name}     & Vaibhav Sijaria \\[4pt]
\textbf{Reg.\ No} & 23BCI0063 \\
\end{tabular}

\vspace{0.8cm}

{\textbf{Date:} 6\textsuperscript{th} April 2026\par}
...
\bottomrule
\end{tabularx}
\captionof{table}{Project artifacts and their roles}
\label{tab:artifacts}
\vspace{0.5em}
% ══════════════════════════════════════════════════════════════════════════════
\section{Method}
